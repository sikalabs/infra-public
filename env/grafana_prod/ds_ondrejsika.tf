...
resource "grafana_data_source" "ondrejsika-prometheus-panda-ingress-os" {
  provider = grafana.ondrejsika
  type     = "prometheus"
...
resource "grafana_data_source" "ondrejsika-prometheus-debora" {
  provider = grafana.ondrejsika
  type     = "prometheus"
  uid      = "ondrejsika-prometheus-debora"
